package com.freedom.leetcode.algorithm;
...
public class Sort {
    ...
    public static void main(String[] args) {
         ...
         * 冒泡排序
         */
        int data1[] = {2, -1, 5, 4, 6, 8, 7, -3};
        Sort.displayData(data1);
        Sort.bubbleSort(data1);
        Sort.displayData(data1);
        /**
         * 快排
         */
        int data2[] = {2, -1, 5, 4, 6, 8, 7, -3};
        Sort.displayData(data2);
        Sort.quickSort(data2, 0, data2.length - 1);
        Sort.displayData(data2);
        /**
         * 合并排序
         */
        int data3[] = {2, -1, 5, 4, 6, 8, 7, -3};
        Sort.displayData(data2);
        Sort.mergeSort(data3, 0, data3.length - 1);
        Sort.displayData(data3);
        /**
         * 插入排序
         */
        int data4[] = {2, -1, 5, 4, 6, 8, 7, -3};
        Sort.displayData(data4);
        Sort.insertSort(data4);
        Sort.displayData(data4);
        /**
         * 选择排序
         */
        int data5[] = {2, -1, 5, 4, 6, 8, 7, -3};
        Sort.displayData(data5);
        Sort.selectSort(data5);
        Sort.displayData(data5);
        /**
         * 希尔排序
         */
        int data6[] = {2, -1, 5, 4, 6, 8, 7, -3};
        Sort.displayData(data6);
        Sort.shellSort(data6);
        Sort.displayData(data6);
        /**
         * 堆排序
         */
        int data7[] = {2, -1, 5, 4, 6, 8, 7, -3};
        Sort.displayData(data7);
        Sort.heapSort(data7);
        Sort.displayData(data7);
        /**
         * 改进冒泡排序
         */
        int data8[] = {2, -1, 5, 4, 6, 8, 7, -3};
        Sort.displayData(data8);
        Sort.improvedBubbleSort(data8);
        Sort.displayData(data8);
    }
}
